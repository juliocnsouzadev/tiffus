 ...
 * @since 3.4
 */
public static NewOutputStream newDeflaterOutputStream(NewOutputStream stream) throws IOException {
	return new ZOutputStream(stream,JZlib.Z_DEFAULT_COMPRESSION);
}
 ...
 * @exception IOException
 */
public static NewOutputStream newFileOutputStream(String filename) throws IOException {
	//TODO GWT for PNG
...
public static InputStream newInflaterInputStream(InputStream stream) throws IOException {
	ZInputStream z = new ZInputStream(stream);
	return z;
}
