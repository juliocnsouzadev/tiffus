...
final class PngEncoder extends Object {
	...
	NewByteArrayOutputStream bytes = new NewByteArrayOutputStream();
	PngChunk chunk;
...
void writeShort(NewByteArrayOutputStream baos, int theShort) {
...
void writeInt(NewByteArrayOutputStream baos, int theInt) {
...
void writeHeader() {
	...
	NewByteArrayOutputStream baos = new NewByteArrayOutputStream(13);
...
void writePalette() {
	...
	NewByteArrayOutputStream baos = new NewByteArrayOutputStream(RGBs.length);
...
void writeTransparency() {
	...
	NewByteArrayOutputStream baos = new NewByteArrayOutputStream();
...
void writeImageData() throws IOException {
	...
	NewByteArrayOutputStream baos = new NewByteArrayOutputStream();
	NewOutputStream os = Compatibility.newDeflaterOutputStream(baos);
